...
export const PAGINAS = {
  ...
  datos: {
    ...
    descripcion:
      ...
      "relaciona con el nivel del río Paraná en el Puerto de Santa Fe. Con " +
      "cada fuente, el cálculo paso a paso y lo que todavía no sabemos.",
    prioridad: "0.9",
    frecuencia: "monthly",
  },
  ...
  paraMedios: {
    ...
    descripcion:
      ...
      "la alerta y la evacuación de la ciudad. Dos líneas de HTML, sin " +
      "claves, sin cookies y " +
      "sin rastreo.",
    prioridad: "0.6",
    frecuencia: "yearly",
  },
