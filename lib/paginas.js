...
export const PAGINAS = {
  ...
  app: {
    ...
    descripcion:
      "La herramienta: el nivel del río Paraná, tu nivel de aviso, el plan " +
      "familiar y los puntos de encuentro. Funciona sin señal una vez " +
      "cargada.",
  },
  ...
  datos: {
    ...
    generada: true,
    indexable: true,
    /* Absorbió a `/mi-cota`, que ahora redirige acá con un 301 (ver
       ...
       «Honestidad también acá» escrito dos veces—, y compitiendo entre sí por
       las mismas búsquedas. Sobrevive ésta porque es la que enlazan el pie, la
       app y otras seis páginas.
       Por eso `busqueda` lista las dos intenciones y la prioridad sube a la de
       `/mi-cota`, que era la más alta de las dos. */
    busqueda:
      "cota de terreno Santa Fe · cota IGN Santa Fe · " +
      "datos y fuentes del río Paraná en Santa Fe",
    titulo: "Cota de tu terreno y datos del río en Santa Fe | Cota Cero",
    descripcion:
      "Qué es la cota de un terreno, de dónde sale la de tu casa y cómo se " +
      "relaciona con el nivel del río Paraná en Santa Fe. Con cada fuente y " +
  ...
  contacto: {
    ...
    generada: true,
    indexable: true,
    busqueda: "contacto Cota Cero · avisar de un error en los datos",
    titulo: "Contacto — avisar de un error en los datos | Cota Cero",
    descripcion:
      "Escribinos si encontraste un dato mal, si falta tu zona o si algo no " +
      "se entiende. Lo lee una persona. No es una vía para pedir ayuda en una " +
      "emergencia.",
    prioridad: "0.5",
    frecuencia: "yearly",
  },
  ...
  paraMedios: {
    ...
    descripcion:
      "Widget gratuito con el nivel del río Paraná en el Puerto de Santa Fe. " +
      "Dos líneas de HTML, sin claves, sin cookies y sin rastreo.",
    prioridad: "0.6",
    frecuencia: "yearly",
  },
  ...
  guia: {
    ...
    generada: true,
    indexable: true,
    busqueda: "guía de emergencia por crecida para imprimir · plan familiar en papel",
    titulo: "Guía de emergencia por crecida, para imprimir | Cota Cero",
    descripcion:
      "Una hoja para llenar a mano y pegar en la heladera: a qué nivel del " +
      "río salir, adónde ir, los teléfonos y la mochila. Se imprime y funciona " +
      "sin señal.",
    prioridad: "0.8",
    frecuencia: "yearly",
  },
