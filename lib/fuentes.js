...
import { UMBRALES_RESPALDO } from "./comun.js";
...
export const ESTACION = {
  ...
  // para cuando la API no responde y la app cae al reporte diario. Los dos
  // umbrales salen de lib/comun.js, que es de donde los leen también el
  // service worker y los scripts del sitio: estuvieron escritos a mano en
  // ocho archivos y son un número de seguridad.
