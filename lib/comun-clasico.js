...
const UMBRALES_RESPALDO = { alerta: 5.3, evacuacion: 5.7 };
...
const m = (v) => (v == null || isNaN(v) ? "—" : nm(v, 2) + " m");
...
const mCm = (v) => {
  ...
  raiz.CC_COMUN = { UMBRALES_RESPALDO, umbralesDe, VENCE_HORAS, nm, m, mU, mCm };
